...
type Command struct {
	...
	Method MethodType `protobuf:"varint,2,opt,name=method,proto3,enum=sysproto.MethodType" json:"method"`
...
func init() {
	proto.RegisterEnum("sysproto.MethodType", MethodType_name, MethodType_value)
	proto.RegisterType((*Command)(nil), "sysproto.Command")
	proto.RegisterType((*Node)(nil), "sysproto.Node")
	proto.RegisterType((*Metrics)(nil), "sysproto.Metrics")
	proto.RegisterMapType((map[string]float64)(nil), "sysproto.Metrics.ItemsEntry")
	proto.RegisterType((*Unsubscribe)(nil), "sysproto.HandleUnsubscribe")
	proto.RegisterType((*Disconnect)(nil), "sysproto.Disconnect")
}
