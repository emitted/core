...
const (
	PacketType_PUBLICATION PacketType = 0
	PacketType_JOIN        PacketType = 1
	PacketType_LEAVE       PacketType = 2
)
...
type Packet struct {
	Type PacketType `protobuf:"varint,1,opt,name=type,proto3,enum=internalproto.PacketType" json:"type,omitempty"`
...
type Publication struct {
	...
	ClientInfo []byte `protobuf:"bytes,5,opt,name=clientInfo,proto3" json:"clientInfo,omitempty"`
}
...
func (m *Publication) GetClientInfo() []byte {
	if m != nil {
		return m.ClientInfo
	}
	return nil
...
func (m *Join) GetClientInfo() []byte {
	if m != nil {
		return m.ClientInfo
	}
	return nil
...
func (m *Leave) GetClientInfo() []byte {
	if m != nil {
		return m.ClientInfo
	}
	return nil
...
func init() {
	proto.RegisterEnum("internalproto.PacketType", PacketType_name, PacketType_value)
	proto.RegisterType((*Packet)(nil), "internalproto.Packet")
	proto.RegisterType((*Publication)(nil), "internalproto.Publication")
	proto.RegisterType((*Join)(nil), "internalproto.Join")
	proto.RegisterType((*Leave)(nil), "internalproto.Leave")
}
...
var fileDescriptor_41f4a519b878ee3b = []byte{
	...
	,
}
...
func (m *Publication) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClientInfo) > 0 {
		...
		i = encodeVarintInternal(dAtA, i, uint64(len(m.ClientInfo)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Uid) > 0 {
	...
	if len(m.Topic) > 0 {
		i -= len(m.Topic)
		copy(dAtA[i:], m.Topic)
		i = encodeVarintInternal(dAtA, i, uint64(len(m.Topic)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Channel) > 0 {
		...
		i = encodeVarintInternal(dAtA, i, uint64(len(m.Channel)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
