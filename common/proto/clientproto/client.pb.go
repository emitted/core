...
const (
	EventType_PUBLICATION EventType = 0
	EventType_JOIN        EventType = 1
	EventType_LEAVE       EventType = 2
	EventType_SERVICE     EventType = 4
)
...
type Command struct {
	...
	Type                 MethodType `protobuf:"varint,2,opt,name=type,proto3,enum=clientproto.MethodType" json:"type,omitempty"`
...
type Packet struct {
	Type                 EventType `protobuf:"varint,1,opt,name=type,proto3,enum=clientproto.EventType" json:"type,omitempty"`
	Data                 []byte    `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	ExcludedUid          string    `protobuf:"bytes,3,opt,name=excludedUid,proto3" json:"excludedUid,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *Packet) GetType() EventType {
	if m != nil {
		return m.Type
	}
	return EventType_PUBLICATION
}
...
func (m *Packet) GetExcludedUid() string {
	if m != nil {
		return m.ExcludedUid
	}
	return ""
}
...
func (m *ClientInfo) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *Publication) GetTopic() string {
	if m != nil {
		return m.Topic
	}
	return ""
...
type Join struct {
	...
	Data                 *ClientInfo `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *SubscribeRequest) GetData() *ClientInfo {
	if m != nil {
		return m.Data
	}
	return nil
...
type ConnectRequest struct {
	Client               ClientType `protobuf:"varint,1,opt,name=client,proto3,enum=clientproto.ClientType" json:"client,omitempty"`
...
func init() {
	proto.RegisterEnum("clientproto.MethodType", MethodType_name, MethodType_value)
	proto.RegisterEnum("clientproto.EventType", EventType_name, EventType_value)
	proto.RegisterEnum("clientproto.ClientType", ClientType_name, ClientType_value)
	proto.RegisterType((*Command)(nil), "clientproto.Command")
	proto.RegisterType((*Error)(nil), "clientproto.Error")
	proto.RegisterType((*Reply)(nil), "clientproto.Reply")
	proto.RegisterType((*Packet)(nil), "clientproto.Packet")
	proto.RegisterType((*Event)(nil), "clientproto.Event")
	proto.RegisterType((*ClientInfo)(nil), "clientproto.ClientInfo")
	proto.RegisterType((*Publication)(nil), "clientproto.Publication")
	proto.RegisterType((*Join)(nil), "clientproto.Join")
	proto.RegisterType((*Leave)(nil), "clientproto.Leave")
	proto.RegisterType((*SubscribeRequest)(nil), "clientproto.SubscribeRequest")
	proto.RegisterType((*UnsubscribeRequest)(nil), "clientproto.UnsubscribeRequest")
	proto.RegisterType((*PublishRequest)(nil), "clientproto.PublishRequest")
	proto.RegisterType((*ConnectRequest)(nil), "clientproto.ConnectRequest")
	proto.RegisterType((*ConnectResult)(nil), "clientproto.ConnectResult")
	proto.RegisterType((*PingRequest)(nil), "clientproto.PingRequest")
	proto.RegisterType((*PingResult)(nil), "clientproto.PingResult")
	proto.RegisterType((*SubscribeResult)(nil), "clientproto.SubscribeResult")
	proto.RegisterType((*UnsubscribeResult)(nil), "clientproto.UnsubscribeResult")
	proto.RegisterType((*PublishResult)(nil), "clientproto.PublishResult")
	proto.RegisterType((*PresenceRequest)(nil), "clientproto.PresenceRequest")
	proto.RegisterType((*PresenceResult)(nil), "clientproto.PresenceResult")
	proto.RegisterMapType((map[string]*ClientInfo)(nil), "clientproto.PresenceResult.PresenceEntry")
}
...
var fileDescriptor_014de31d7ac8c57c = []byte{
	...
	,
}
...
func (m *Packet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExcludedUid) > 0 {
		i -= len(m.ExcludedUid)
		copy(dAtA[i:], m.ExcludedUid)
		i = encodeVarintClient(dAtA, i, uint64(len(m.ExcludedUid)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Data) > 0 {
...
func (m *Packet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExcludedUid", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExcludedUid = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipClient(dAtA[iNdEx:])
